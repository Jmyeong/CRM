...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "jbnu_stereo"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 default="kitti",
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", "jbnu_stereo"])
        ...
        # GLASS HINT options
        self.parser.add_argument("--use_glass_hints",
                                 help="if set, apply glass hints during training",
                                 action="store_true")
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="eigen",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10", "jbnu_stereo"],
