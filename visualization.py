...
# model_name = "jbnu_stereo_student_monodepth2_no_crm"
model_name = "jbnu_stereo_student_monodepth2_do_crm"
# model_name = "kitti"
...
def main(args):
    ...
    encoder_checkpoint = torch.load(f"/ssd1/jm_data/depth/ssl/depth-hints/logs/{model_name}/models/weights_{args.epoch}/encoder.pth", map_location=device)
    decoder_checkpoint = torch.load(f"/ssd1/jm_data/depth/ssl/depth-hints/logs/{model_name}/models/weights_{args.epoch}/depth.pth", map_location=device)
