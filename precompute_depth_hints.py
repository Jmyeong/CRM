...
class DepthHintDataset:
    ...
    def __init__(self,
        ...
        self.baseline = 0.12  # the same baseline in datasets/mono_dataset.py
    ...
    def __getitem__(self, index):
        ...
        # print(os.path.join(self.data_path, sequence, side,
